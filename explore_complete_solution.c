...
int main(int argc, char *argv[]) {
  ...
  complete_graph_reader cgr = load_complete_graph_reader(argv[1]);
  ...
  while (true) {
    ...
    value v = get_complete_graph_reader_value(&cgr, &s);
  ...
  cleanup:
  unload_complete_graph_reader(&cgr);
