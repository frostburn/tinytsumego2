...
collection rectangle_six() {
  ...
  return (collection){
      "rectangle-six", "Rectangular Six in the Corner", root, true, sizeof(tsumegos) / sizeof(tsumego), ts, COMPRESSED_KEYSPACE,
  };
}
...
collection rectangle_eight() {
  ...
  return (collection){
      "rectangle-eight", "Rectangular Eight in the Corner", root, true, sizeof(tsumegos) / sizeof(tsumego), ts, COMPRESSED_KEYSPACE,
  };
}
...
collection l_j_groups() {
  ...
  tsumego tsumegos[] = {
      ...
      {"straight-j-group-defense",
       "Straight J Group (Defense)",
       straight_j_group_def,
       false,
       {straight_j_group_def_score, straight_j_group_def_score}},
      {"straight-j-group-attack",
       "Straight J Group (Attack)",
       straight_j_group_att,
       false,
       {straight_j_group_att_score, straight_j_group_att_score}},
      {"straight-j-group-sac",
       "Straight J Group (Sacrifice)",
  ...
  return (collection){
      "l-j-groups", "L & J Groups", root, true, sizeof(tsumegos) / sizeof(tsumego), ts, COMPRESSED_KEYSPACE,
  };
}
...
collection notcher_122xy() {
  ...
  return (collection){
      "122xy", "Notchers 122xy", root, true, sizeof(tsumegos) / sizeof(tsumego), ts, COMPRESSED_KEYSPACE,
  };
}
...
collection rectangular_goban(int width, int height, bool wide, keyspace_type type) {
  ...
  return (collection){
      slug, title, root, false, sizeof(tsumegos) / sizeof(tsumego), ts, type,
  };
}
...
collection carpenters_square() {
  ...
  return (collection){
      "carpenters-square", "Carpenter's Square", root, true, sizeof(tsumegos) / sizeof(tsumego), ts, COMPRESSED_KEYSPACE,
  };
}
...
collection long_l_group() {
  ...
  tsumego tsumegos[] = {
      {"no-liberties-mannen-ko",
       "No Outside Liberties (Mannen-Ko)",
       no_libs_mannen_ko,
       false,
       {no_libs_mannen_ko_score, no_libs_mannen_ko_score}},
      {"no-liberties-ko", "No Outside Liberties (Ko)", no_libs_ko, false, {no_libs_ko_score, no_libs_ko_score}},
      {"no-liberties-hane-seki",
       "No Outside Liberties w/ Hane (Seki)",
       no_libs_hane_seki,
       false,
  ...
  return (collection){
      "long-l-group", "Long L Group", root, true, sizeof(tsumegos) / sizeof(tsumego), ts, COMPRESSED_KEYSPACE,
  };
}
...
collection five_on_3rd() {
  ...
  tsumego tsumegos[] = {
      ...
      {"lesser-endgame-defense",
       "Lesser Endgame (Defense)",
       lesser_endgame_def,
       false,
       {lesser_endgame_def_score, lesser_endgame_def_score}},
  ...
  return (collection){
      "5-on-3rd", "Five on the Third Line in the Corner", root, true, sizeof(tsumegos) / sizeof(tsumego), ts, COMPRESSED_KEYSPACE,
  };
}
